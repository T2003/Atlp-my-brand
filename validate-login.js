...
const username_login = document.getElementById('text1')
const password_login = document.getElementById('myInput')
...
const endpoint = "https://my-brand-app-v1.herokuapp.com/api/docs/#/Users/post_api_users_login";
